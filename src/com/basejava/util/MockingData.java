...
public class MockingData {
    ...
    private final Map<DataType, String[]> MOCK_DATA = new HashMap<>();
    //10 numbers
    private final String[] PHONE_NUMBERS = {"(555) 123-4567", "(555) 987-6543", "(555) 555-1212", "(555) " + "456-7890"
            , "(555) 777-8888", "(555) 999-0000", "(555) 222-3333", "(555) 444-5555", "(555) 888-9999", "(555) " +
                                                                                                        "111" +
                                                                                                        "-2222"};
    //10 mails
    private final String[] EMAILS = new String[]{"gmail", "yahoo", "hotmail", "outlook", "icloud", "protonmail", "aol"
            , "inbox", "fastmail.com", "hushmail.com"};
    //10 positions
    private final String[] POSITIONS = new String[]{"Serving as a project manager for a team of 10.",
            ...
            "Serving as " + "a customer " + "service representative for a multinational corporation.", "Working as a "
                                                                                                       + "sales" + " "
                                                                                                       + "executive " + "for" + " a" + " leading e-commerce platform.", "Holding a " + "teaching " + "position at a " + "local " + "university.", "Employed " + "as a " + "human resources " + "manager for a " + "global " + "organization" + ".", "Serving as a financial " + "analyst for a " + "major " + "investment" + " " + "firm.", "Working " + "as a " + "research assistant for a renowned " + "academic institution."};
    //10 personals
    private final String[] PERSONALS =
            new String[]{"Strong attention to detail and a focus on accuracy in " + "all" + " tasks.",
                    "Excellent " + "problem-solving skills " + "and" + " ability to think creatively.", "Highly" + " "
                                                                                                        ...
                                                                                                        "to" + " " +
                                                                                                        "manage " +
                                                                                                        "multiple " + "tasks " + "simultaneously.", "Strong " + "communication" + " " + "skills and ability to " + "work " + "effectively with teams.", "Positive" + " " + "attitude and " + "ability" + " " + "to stay motivated even in " + "challenging" + " " + "situations.", "Adaptable and " + "able" + " to " + "quickly " + "learn new skills and" + " " + "processes.", "Ability to " + "work " + "well under " + "pressure " + "and meet " + "tight " + "deadlines.", "Demonstrated " + "leadership " + "skills and " + "ability to motivate " + "others" + ".", "Strong " + "work ethic " + "and " + "commitment to quality in all work.", "Adept at" + " " + "balancing" + " " + "competing priorities " + "and making " + "effective " + "decisions."};
    ...
    private final String[] ACHIEVEMENTS =
            new String[]{"Increased sales by 25% over a six-month period " + "through" + " the implementation of " +
                         "targeted marketing campaigns", "Recognized as top-performing " + "sales " + "representative"
                                                         + " for " + "two consecutive quarters", "Developed " + "and "
                                                                                                 + "executed " +
                                                                                                 "successful customer" +
                                                                                                 " " + "retention" +
    ...
    private final String[] QUALIFICATIONS = new String[]{"Excellent communication skills",
    ...
    private final String[] DATES = {"2014-10", "2016-01", "2015-05", "2017-08", "2018-02", "2020-06", "2019-11", "2022"
                                                                                                                 +
                                                                                                                 "-01"
            , "2012-09", "2014-12", "2017-03", "2019-06", "2020-10", "2022-12", "2011-06", "2013-09", "2016-01",
            ...
            "2019" + "-11", "2011-07", "2013-02", "2014-04", "2015-10", "2014-10", "2016-01", "2018-05", "2019" +
                                                                                                         "-09", "2022"
                                                                                                                +
                                                                                                                "-02"
            , "2023-04", "2015-06", "2017-12", "2019-08", "2020-11", "2016-03", "2018" + "-08", "2020" + "-01", "2022" +
                                                                                                                "-07"
            , "2015-09", "2017-11", "2019-05", "2021-08", "2016-02", "2018" + "-06", "2014" + "-10", "2016-01", "2008" +
                                                                                                                "-02"
            , "2009-05", "2013-06", "2015-11", "2010-09", "2012-12", "2005-04", "2007-07", "2009-11", "2011-02",
            "2012-03", "2014-06", "2015-08", "2017-11", "2006-01", "2007" + "-04", "2018-06", "2020-09", "2013-01",
            "2014-04", "2011-07", "2013-10", "2004-10", "2006-01", "2019-04", "2021" + "-07", "2015" + "-01", "2016" +
                                                                                                              "-04",
            "2017-10", "2019-01", "2008-05", "2009-08", "2014-08", "2016" + "-11", "2010" + "-03", "2012-06", "2007" +
                                                                                                              "-02",
            "2008-05", "2012-10", "2014-01", "2016-05", "2018" + "-08", "2009" + "-12", "2011" + "-03", "2005-09",
            "2007-12", "2013-04", "2015-07", "2011-10", "2013" + "-01", "2006" + "-07", "2007-10", "2018-02",
            "2019" + "-05", "2014-05", "2016-08", "2010-08", "2012-11", "2008" + "-03", "2009" + "-06", "2015" + "-02"
            , "2016-05", "2007-11", "2009-02", "2012-04", "2014-07", "2016-09", "2018-12", "2013-02", "2014-05",
            "2005" + "-05", "2006-08", "2011" + "-08", "2013-11", "2019" + "-01", "2020" + "-04", "2014-02",
            "2015" + "-05", "2009-09", "2010" + "-12", "2006-04", "2007-07", "2017" + "-01", "2018-04", "2010-04",
            "2012-07", "2008" + "-06", "2009-09", "2015-03", "2016-06", "2012" + "-11", "2013" + "-02", "2019-07",
            "2020-12", "2017-05", "2018-11", "2022-01", "2023-06"};
    //20 company names and websites
    private final String[] COMPANY_WEBSITES = {"greenmountaincoffeeroasters.com", "freshchoice.com", "peachtreenetwork"
                                                                                                     + ".com",
            "thegadgetstore.com", "mountainviewgroup.com", "cascadeindustries.com", "sapphireenterprises" + ".com",
            "gvea.com", "pacificcoastcreative.com", "meadowbrookfarms.com", "oceanicservices.com",
            "morningglorybakery.com", "summitconsultinggroup.com", "redwoodenergysolutions" + ".com",
            "blueridgefurniture" + ".com", "pioneermarketing.com", "cedarcreekconstruction.com",
            "rockymountainproductions" + ".com", "islandbreezehospitality.com", "horizonglobal.com"};
    private final String[] COMPANY_NAMES = {"Green Mountain Coffee Roasters", "Fresh Choice", "Peachtree " + "Network"
            , "The Gadget Store", "Mountain View Group", "Cascade Industries", "Sapphire Enterprises", "Golden " +
                                                                                                       "Valley" + " " + "Electric " + "Association", "Pacific Coast Creative", "Meadowbrook Farms", "Oceanic " + "Services", "Morning " + "Glory Bakery", "Summit Consulting Group", "Redwood Energy " + "Solutions", "Blue " + "Ridge " + "Furniture", "Pioneer " + "Marketing", "Cedar Creek Construction", "Rocky Mountain " + "Productions", "Island " + "Breeze " + "Hospitality", "Horizon Global"};
    //20 educational names and websites
    private final String[] EDUCATION_NAMES = {"Harvard University", "Stanford University", "Massachusetts " +
                                                                                           "Institute of Technology",
            "University of Oxford", "University of Cambridge", "California Institute of " + "Technology", "Princeton " +
                                                                                                          "University"
            , "University of Chicago", "Yale " + "University", "Columbia University", "University of Pennsylvania",
            "Imperial College London", "ETH " + "Zurich", "University of " + "California, " + "Berkeley", "University" +
                                                                                                          " of " +
                                                                                                          "Michigan",
            "University of Tokyo", "National University of Singapore", "Peking " + "University", "University of " +
                                                                                                 "Melbourne",
            "University of " + "Toronto"};
    private final String[] EDUCATION_WEBSITES = {"harvarduniversity.edu", "stanforduniv.edu", "mit.edu",
            "oxforduniv" + ".edu", "cambridgeuniv.edu", "caltech.edu", "princetonuniv.edu", "uchicago.edu", "yaleuniv"
                                                                                                            + ".edu",
            "columbiauniv.edu", "upenn.edu", "imperialcollege.edu", "ethzurich.edu", "ucberkeley.edu", "umich" +
                                                                                                       ".edu",
            "utokyo.edu", "nus.edu", "pekinguniv.edu", "unimelb.edu", "uoft.edu"};
    //40 educational titles and descriptions, because every person has 1 education section with 2 periods
    private final String[] EDUCATION_TITLE = {"Bachelor's degree in Computer Science", "Master in Computer " +
                                                                                       "Science",
            "Bachelor's degree " + "in Psychology", "Master in Counseling", "Bachelor's degree in Biology", "Master " +
                                                                                                            "in Medical Science", "Bachelor's degree in Business Administration", "Master in Finance", "Bachelor's degree in Education", "Master in Curriculum and Instruction", "Bachelor's degree in " + "Communications", "Master in " + "Public " + "Relations", "Bachelor's degree in Engineering", "Master in " + "Mechanical" + " Engineering", "Bachelor's degree in History", "Master in Cultural Studies", "Bachelor's " + "degree in " + "English", "Master in Creative Writing", "Bachelor's degree in Environmental Science", "Master in " + "Sustainability", "Bachelor's degree in Political Science", "Master in International " + "Relations", "Bachelor's " + "degree in " + "Economics", "Master in Applied Economics", "Bachelor's degree in " + "Marketing", "Master in Digital Marketing", "Bachelor's degree in Graphic Design", "Master in Fine Arts", "Bachelor's " + "degree in Sociology", "Master in Social Work", "Bachelor's degree in Mathematics", "Master in " + "Statistics", "Bachelor's degree in Nutrition", "Master in Dietetics", "Bachelor's degree " + "in Criminal " + "Justice", "Master " + "in Criminal Justice", "Bachelor's degree in Public Health", "Master" + " " + "in Health " + "Administration", "Bachelor's degree in Music", "Master in Music Education"};
    private final String[] EDUCATION_DESCRIPTION = {"Faculty of Computer Science", "Faculty of Computer " + "Science",
            "Faculty of Social Sciences or Faculty of Arts and Humanities", "Faculty of Education or " + "Faculty of "
                                                                            + "Social Work", "Faculty of Science",
            "Faculty of Medicine or Faculty of Health Sciences", "Faculty of " + "Business or School of Management",
            "Faculty of Business or School of Management", "Faculty " + "of" + " " + "Education", "Faculty of " +
                                                                                                  "Education",
            "Faculty of Communications or School of " + "Journalism", "Faculty " + "of " + "Communications or School "
                                                                      + "of Journalism",
            "Faculty of Engineering or " + "School" + " of " + "Engineering", "Faculty of " + "Engineering or School " +
                                                                              "of Engineering", "Faculty of " + "Arts" +
                                                                                                " and " + "Humanities" +
                                                                                                " or" + " Department " +
                                                                                                "of " + "History",
            "Faculty of Arts and " + "Humanities" + " or Department " + "of Cultural " + "Studies", "Faculty of" + " " +
                                                                                                    "Arts and " +
                                                                                                    "Humanities or " + "Department " + "of English", "Faculty" + " of Arts and " + "Humanities or Department of " + "Creative Writing", "Faculty" + " of " + "Science or School" + " of " + "Environmental " + "Studies", "Faculty of " + "Environmental Studies " + "or School of " + "Sustainability", "Faculty of Social " + "Sciences or Department of " + "Political " + "Science", "Faculty of Social " + "Sciences or Department of " + "International Relations", "Faculty" + " of Social " + "Sciences or " + "Department " + "of " + "Economics", "Faculty of" + " Social Sciences or " + "Department " + "of" + " " + "Economics", "Faculty of " + "Business or " + "School of " + "Marketing", "Faculty " + "of " + "Business" + " or School of " + "Marketing", "Faculty of " + "Fine" + " Arts or School of Design", "Faculty " + "of" + " Fine Arts or School of " + "Design", "Faculty of Social " + "Sciences or " + "Department of " + "Sociology", "Faculty " + "of " + "Social" + " Work or " + "Department of Social " + "Work", "Faculty of " + "Science or " + "Department of " + "Mathematics", "Faculty of " + "Science or Department of " + "Statistics", "Faculty of" + " Health " + "Sciences or " + "Department of " + "Nutrition", "Faculty of Health Sciences or " + "Department " + "of " + "Dietetics", "Faculty of" + " Social " + "Sciences or" + " School of " + "Criminal Justice", "Faculty" + " of " + "Social " + "Sciences or " + "School " + "of Criminal Justice", "Faculty of Health " + "Sciences or " + "School of " + "Public " + "Health", "Faculty " + "of Health Sciences or School " + "of " + "Health " + "Administration", "Faculty of " + "Music or " + "Department " + "of " + "Music", "Faculty of" + " Education" + " " + "or" + " " + "Department of Music"};

    private MockingData() {
        MOCK_DATA.put(DataType.PHONE_NUMBER, PHONE_NUMBERS);
        MOCK_DATA.put(DataType.EMAIL, EMAILS);
        MOCK_DATA.put(DataType.POSITION, POSITIONS);
        MOCK_DATA.put(DataType.PERSONAL, PERSONALS);
        MOCK_DATA.put(DataType.ACHIEVEMENT, ACHIEVEMENTS);
        MOCK_DATA.put(DataType.QUALIFICATION, QUALIFICATIONS);
        MOCK_DATA.put(DataType.WORK_TITLE, WORK_TITLES);
        MOCK_DATA.put(DataType.WORK_DESCRIPTION, WORK_DESCRIPTIONS);
        MOCK_DATA.put(DataType.DATE, DATES);
        MOCK_DATA.put(DataType.COMPANY_NAME, COMPANY_NAMES);
        MOCK_DATA.put(DataType.COMPANY_WEBSITE, COMPANY_WEBSITES);
        MOCK_DATA.put(DataType.EDUCATION_NAME, EDUCATION_NAMES);
        MOCK_DATA.put(DataType.EDUCATION_WEBSITE, EDUCATION_WEBSITES);
        MOCK_DATA.put(DataType.EDUCATION_TITLE, EDUCATION_TITLE);
        MOCK_DATA.put(DataType.EDUCATION_DESCRIPTION, EDUCATION_DESCRIPTION);
    }
    ...
    public Iterator<String> getIterator(DataType type) {
        return Arrays.stream(MOCK_DATA.get(type)).iterator();
    }
}
