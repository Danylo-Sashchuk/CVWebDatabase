...
public class ResumeTestData {
    ...
    private void addContacts(String fullName, Resume resume) {
        resume.setContact(ContactType.PHONE_NUMBER, iterators.get(DataType.PHONE_NUMBER).next());
        resume.setContact(ContactType.EMAIL, generateEmail(fullName));
        resume.setContact(ContactType.GITHUB, generateLink(fullName, "https://github.com/"));
        resume.setContact(ContactType.LINKEDIN, generateLink(fullName, "https://www.linkedin.com/in/"));
        resume.setContact(ContactType.SKYPE, generateSkype(fullName));
    }
