...
public class MockingData {
    //10 numbers
    public static final String[] PHONE_NUMBERS = {"(555) 123-4567", "(555) 987-6543", "(555) 555-1212", "(555) " +
            "456-7890", "(555) 777-8888", "(555) 999-0000", "(555) 222-3333", "(555) 444-5555", "(555) 888-9999",
            "(555) " + "111" + "-2222"};
    //10 mails
    public static final String[] EMAILS = new String[]{"gmail", "yahoo", "hotmail", "outlook", "icloud", "protonmail"
            , "aol", "inbox", "fastmail.com", "hushmail.com"};
    //10 positions
    public static final String[] POSITIONS = new String[]{"Serving as a project manager for a team of 10.",
    ...
    //10 personals
    public static final String[] PERSONALS = new String[]{"Strong attention to detail and a focus on accuracy in " +
            "all" + " tasks.", "Excellent " + "problem-solving skills " + "and" + " ability to think creatively.",
    ...
    public static final String[] ACHIEVEMENTS = new String[]{"Increased sales by 25% over a six-month period " +
    ...
    public static final String[] WORK_TITLES = {"Marketing Manager", "Software Engineer", "Operations Coordinator",
    ...
    public static final String[] WORK_DESCRIPTIONS = {"Performed daily tasks related to database management and " +
    ...
    public static final String[] DATES = {"2014-10", "2016-01", "2015-05", "2017-08", "2018-02", "2020-06", "2019-11"
            ...
            "2018-06", "2019" + "-11", "2011-07", "2013-02", "2014-04", "2015-10", "2014-10", "2016-01", "2018-05",
            "2019" + "-09", "2022" + "-02", "2023-04", "2015-06", "2017-12", "2019-08", "2020-11", "2016-03",
            "2018" + "-08", "2020" + "-01", "2022-07", "2015-09", "2017-11", "2019-05", "2021-08", "2016-02",
            "2018" + "-06", "2014-10", "2016-01", "2008-02", "2009-05", "2013-06", "2015-11", "2010-09", "2012-12",
            "2005-04", "2007-07", "2009-11", "2011-02", "2012-03", "2014-06", "2015-08", "2017-11", "2006-01",
            "2007" + "-04", "2018-06", "2020-09", "2013-01", "2014-04", "2011-07", "2013-10", "2004-10", "2006-01",
            "2019-04", "2021-07", "2015-01", "2016-04", "2017-10", "2019-01", "2008-05", "2009-08", "2014-08",
            "2016" + "-11", "2010" + "-03", "2012-06", "2007-02", "2008-05", "2012-10", "2014-01", "2016-05",
            "2018" + "-08", "2009" + "-12", "2011-03", "2005-09", "2007-12", "2013-04", "2015-07", "2011-10",
            "2013" + "-01", "2006" + "-07", "2007-10", "2018-02", "2019" + "-05", "2014-05", "2016-08", "2010-08",
            "2012-11", "2008-03", "2009" + "-06", "2015-02", "2016-05", "2007-11", "2009-02", "2012-04", "2014-07",
            "2016-09", "2018-12", "2013-02", "2014-05", "2005" + "-05", "2006-08", "2011" + "-08", "2013-11",
            "2019" + "-01", "2020" + "-04", "2014-02", "2015" + "-05", "2009-09", "2010" + "-12", "2006-04", "2007-07"
            , "2017" + "-01", "2018-04", "2010-04", "2012-07", "2008" + "-06", "2009-09", "2015-03", "2016-06", "2012"
            + "-11", "2013" + "-02", "2019-07", "2020-12", "2017-05", "2018-11", "2022-01", "2023-06"};
    //20 company names and websites
    public static final String[] COMPANY_WEBSITES = {"greenmountaincoffeeroasters.com", "freshchoice.com",
    ...
    public static final String[] COMPANY_NAMES = {"Green Mountain Coffee Roasters", "Fresh Choice", "Peachtree " +
            "Network", "The Gadget Store", "Mountain View Group", "Cascade Industries", "Sapphire Enterprises",
            "Golden " + "Valley" + " Electric Association", "Pacific Coast Creative", "Meadowbrook Farms",
            "Oceanic " + "Services", "Morning " + "Glory Bakery", "Summit Consulting Group", "Redwood Energy " +
            "Solutions", "Blue " + "Ridge " + "Furniture", "Pioneer " + "Marketing", "Cedar Creek Construction",
            "Rocky Mountain " + "Productions", "Island " + "Breeze " + "Hospitality", "Horizon Global"};
    //20 educational names and websites
    public static final String[] EDUCATION_NAMES = {"Harvard University", "Stanford University", "Massachusetts " +
    ...
    public static final String[] EDUCATION_WEBSITES = {"harvarduniversity.edu", "stanforduniv.edu", "mit.edu",
            "oxforduniv.edu", "cambridgeuniv.edu", "caltech.edu", "princetonuniv.edu", "uchicago.edu", "yaleuniv.edu"
            , "columbiauniv.edu", "upenn.edu", "imperialcollege.edu", "ethzurich.edu", "ucberkeley.edu", "umich.edu",
    ...
    public static final String[] EDUCATION_TITLE = {"Bachelor's degree in Computer Science", "Master in Computer " +
    ...
    public static final String[] EDUCATION_DESCRIPTION = {"Faculty of Computer Science", "Faculty of Computer " +
            "Science", "Faculty of Social Sciences or Faculty of Arts and Humanities", "Faculty of Education or " +
            "Faculty of Social Work", "Faculty of Science", "Faculty of Medicine or Faculty of Health Sciences",
            "Faculty of Business or School of Management", "Faculty of Business or School of Management",
            "Faculty " + "of" + " Education", "Faculty of Education", "Faculty of Communications or School of " +
            "Journalism", "Faculty of " + "Communications or School of Journalism", "Faculty of Engineering or " +
            "School" + " of " + "Engineering", "Faculty of " + "Engineering or School of Engineering",
            "Faculty of " + "Arts and " + "Humanities or" + " Department of History", "Faculty of Arts and " +
            "Humanities" + " or Department " + "of Cultural " + "Studies",
    ...
    private static MockingData instance;
    private MockingData() {
    }
    ...
    public static Iterator<String> getIterator(String[] from) {
